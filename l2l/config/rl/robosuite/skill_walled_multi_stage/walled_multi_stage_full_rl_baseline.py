...
from l2l.modules.robosuite_feature_extractor import WalledMultiStageFullRLBaselineFeatureExtractor
...
model_config = AttrDict(
    ...
    model_config=AttrDict(
        ...
        policy_kwargs=dict(
            features_extractor_class=WalledMultiStageFullRLBaselineFeatureExtractor,
