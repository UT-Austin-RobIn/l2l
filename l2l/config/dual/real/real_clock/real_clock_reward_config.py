...
from l2l.wrappers.real_wrappers import SimAndRealRewardWrapper, DisplayStringWrapper, DisplayImageWrapper

environment_config = AttrDict(
    env_config=env_config,
    wrappers=[SimAndRealRewardWrapper, DisplayStringWrapper, Monitor],
    num_envs=1,
)
