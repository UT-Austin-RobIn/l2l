...
from l2l.wrappers.real_wrappers import SimAndRealRewardWrapper, TiagoHandAndHeadWrapper, \
    OnOffDisplayImageWrapper, CameraAndHandExplorationBonus

environment_config = AttrDict(
    env_config=env_config,
    wrappers=[TiagoHandAndHeadWrapper, SimAndRealRewardWrapper, OnOffDisplayImageWrapper, 
              Monitor],
    num_envs=1,
)
