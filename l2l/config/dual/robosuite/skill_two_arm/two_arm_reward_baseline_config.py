...
from l2l.modules.robosuite_feature_extractor import TwoArmFeatureExtractor
...
if env_config.pi_format == "onehot":
    ...
    bc_ckpt = "/home/shivin/Desktop/learning2look/experiments_imitation/two_arm/weights/weights_ep15.pth"
else:
...
rl_model_config = AttrDict(
    ...
    model_kwargs=AttrDict(
        ...
        policy_kwargs=dict(
            features_extractor_class=TwoArmFeatureExtractor,
